CREATE TABLE RETAILER (
    ...
    RETAILER_retailer_contact_code VARCHAR(50),
...
CREATE TABLE ORDERS (
    ...
    FOREIGN KEY (order_method) REFERENCES PRODUCT(PRODUCT_order_method),
    FOREIGN KEY (retailer_site_code) REFERENCES RETAILER(RETAILER_retailer_site_code),
    FOREIGN KEY (retailer_contact_code) REFERENCES RETAILER(RETAILER_retailer_contact_code),
    FOREIGN KEY (sales_staff_code) REFERENCES SALES_STAFF(SALES_STAFF_code),
    FOREIGN KEY (sales_branch_code) REFERENCES SALES_STAFF(SALES_STAFF_sales_branch)
);